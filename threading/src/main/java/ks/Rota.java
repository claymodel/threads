...
public class Rota extends JComponent {
	private Image image;
	...
	public void paint(Graphics g) {
		...
		g2.setPaint(new GradientPaint(40, 40, Color.blue, 60, 50, Color.white,
				true));
		g2.fill(c);
		...
		g2.setPaint(new GradientPaint(-cx, 0, Color.red, cx, 0, Color.black,
				false));
		...
		Shape r = new RoundRectangle2D.Float(0, -cy * 3 / 4, cx * 3 / 4,
				cy * 3 / 4, 20, 20);
	...
	public static void main(String[] args) {
		...
		frame.add(new Rota(), BorderLayout.CENTER);
